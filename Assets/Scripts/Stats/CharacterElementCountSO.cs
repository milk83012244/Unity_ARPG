...
public class CharacterElementCountSO : SerializedScriptableObject
{
    ...
    public Dictionary<ElementType, Coroutine> elementCountDownDic = new Dictionary<ElementType, Coroutine>();//1階持續時間
    ...
    [HideInInspector] public UnityEvent<ElementType> State2MixEffectTriggerEvent = new UnityEvent<ElementType>();
